...
import numpy as np
import torch
from utils import fitCubic, FindPts, fitBezier3, cal_line_coef, fitBezier2, fitPolyDP, fitSplines
...
#     default='/data/linkejun/models/freespace/YOLOPv2/seg_lane/da_ll/best_384x640_bn_fp16.engine', help='trt model path')
parser.add_argument('--model', type=str, 
    default='/data/linkejun/models/freespace/yolopv2-tiny/tt-lane-selfData/best-0.25.engine', help='trt model path')
...
# parser.add_argument('--imgFile', type=str, default='./inference/images/1885.jpg', help='img path') 
# parser.add_argument('--imgFile', type=str, default='/data/linkejun/dataset/sourceImg/source/camera_0_4/1872.jpg', help='img path')  
# parser.add_argument('--imgFile', type=str, default='/data/linkejun/dataset/sourceImg/source/b_line/images_3/9.jpg', help='img path') 
...
if __name__ == "__main__":
    ...
    # ll_show_binary = cv2.imread("./inference/output/ll_output_net.png")
    ...
    # cv2.imwrite("./inference/output/ll_output_net_appox.png", ll_show_binary)
    cv2.imwrite("./inference/output/ll_output_appox.png", img_draw)
