...
def parse_args():
    ...
    parser.add_argument('--logDir',
                        help='log directory',
                        type=str,
                        default='/home/wyh/models/yolop/aiDog-det-0.5')
    parser.add_argument('--weights', type=str, default='/home/wyh/models/yolop/aiDog-det-0.5/epoch-best.pth', help='model.pth path(s)')
    parser.add_argument('--phase', type=str, default='best-selfData', help='model phase')
...
def main():
    ...
    da_segment_results,ll_segment_results,detect_results, total_loss,maps, times = validate(
        cfg, valid_loader, model, criterion, final_output_dir, device=device, half=True, rank=-1)
